import { LitElement as _, html as l } from "lit";
import { property as g, state as d } from "lit/decorators.js";
import { A as m } from "./animate-on-scroll-ROUn9sF1.js";
import "./fonts-ClHg20Ea.js";
var v = Object.defineProperty, o = (c, t, r, i) => {
  for (var e = void 0, a = c.length - 1, s; a >= 0; a--)
    (s = c[a]) && (e = s(t, r, e) || e);
  return e && v(t, r, e), e;
};
class n extends _ {
  constructor() {
    super(...arguments), this.currentVariantIndex = 0, this.isTransitioning = !1, this.lightboxOpen = !1, this.lightboxSrc = "", this.styleElement = null;
  }
  ...
  disconnectedCallback() {
    var t;
    super.disconnectedCallback(), (t = this.styleElement) == null || t.remove(), this.styleElement = null;
  }
  updated(t) {
  ...
  injectStyles() {
    ...
    const t = ((s = this.config) == null ? void 0 : s.bg_color) || "#ffffff", r = ((p = this.config) == null ? void 0 : p.primary_color) || "#050505", i = ((h = this.config) == null ? void 0 : h.brand_color) || "#0071E3", e = "#F8F8F8", a = "#DDDDDD";
  ...
  selectVariant(t) {
    this.isTransitioning || t === this.currentVariantIndex || (this.isTransitioning = !0, this.requestUpdate(), setTimeout(() => {
      this.currentVariantIndex = t, this.requestUpdate(), setTimeout(() => {
        this.isTransitioning = !1, this.requestUpdate();
      }, 175);
    }, 175));
  }
  openLightbox(t) {
    this.lightboxSrc = t, this.lightboxOpen = !0;
  }
  closeLightbox() {
    this.lightboxOpen = !1;
  }
    ...
    return l`
            ...
            <div class="st-variants__selector">
              <div class="st-variants__product-wrap">
                <img
                  ...
                  alt="${i.color_title}"
                  loading="lazy"
                  class="st-variants__product-image ${e}"
                  @click="${() => this.openLightbox(i.product_image)}"
                />
                <img
                  src="${i.side_image}"
                  alt="${i.color_title}"
                  loading="lazy"
                  class="st-variants__mobile-side-image ${e}"
                  @click="${() => this.openLightbox(i.side_image)}"
                />
              </div>
      ...
      (a, s) => l`
                      ...
                      >
                        ...
                        ></span>
                        <span class="st-variants__color-label">${a.color_title}</span>
                      </button>
                    `
    )}
                </div>
            ...
            >
              <img
                ...
                alt="${i.color_title}"
                loading="eager"
                class="st-variants__side-image ${e}"
              />
            </div>
...
o([
  d()
], n.prototype, "currentVariantIndex");
o([
  d()
], n.prototype, "isTransitioning");
o([
  d()
], n.prototype, "lightboxOpen");
o([
  d()
], n.prototype, "lightboxSrc");
typeof n < "u" && n.registerSallaComponent("salla-st-variants");
export {
  n as default
};
